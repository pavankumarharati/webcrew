...
export const metadata = {
  ...
  description: 'A 24/7 AI receptionist that handles recurring bookings and reschedules without tying up your team — plus a website built overnight. $0 setup, 30-day free trial, $297/mo flat.',
