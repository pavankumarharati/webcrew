...
export const metadata = {
  ...
  description: 'A 24/7 AI receptionist that captures the project details you need before a walk-through — plus a website built overnight. $0 setup, 30-day free trial, $297/mo flat.',
